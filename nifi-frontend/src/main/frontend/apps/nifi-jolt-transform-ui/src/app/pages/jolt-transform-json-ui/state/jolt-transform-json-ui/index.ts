...
export interface JoltTransformJsonUiState {
    ...
    validatingJoltSpec: boolean;
    savingProperties: boolean;
    loadedTimestamp: string;
    status: 'pending' | 'loading' | 'success';
    savePropertiesResponse?: SavePropertiesSuccess;
    savePropertiesFailureResponse?: HttpErrorResponse;
    validationResponse?: ValidateJoltSpecSuccess;
    validationFailureResponse?: HttpErrorResponse;
    transformationResponse?: TransformJoltSpecSuccess;
    transformationFailureResponse?: HttpErrorResponse;
