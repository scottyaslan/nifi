...
@Directive()
export abstract class CanvasBase implements OnInit, OnDestroy {
    private svg: any;
    private canvas: any;
    ...
    constructor(
        ...
        protected store: Store<CanvasState>,
        protected canvasView: CanvasView,
        protected canvasContextMenu: CanvasContextMenu
    ) {
        this.store
