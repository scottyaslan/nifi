    ...
    function (nfCommon,
        ...
        var performListing = function (connection) {
            ...
            return $.Deferred(function (deferred) {
                ...
                var pollListingRequest = function (nextDelay) {
                    ...
                    }).fail(completeListingRequest).fail(nfCommon.handleAjaxError);
                };
        ...
        return {
            init: function (canvas) {
                ...
                nfCommon.addHoverEffect('#queue-listing-refresh-button', 'button-refresh', 'button-refresh-hover').click(function () {
                ...
                var penalizedFormatter = function (row, cell, value, columnDef, dataContext, canvas) {
                    var markup = '';
            ...
            listQueue: function (connection) {
                ...
                performListing(connection).done(function () {
                    ...
                    var connectionName = nfCanvasUtils.formatConnectionName(connection.component);
                    if (connectionName === '') {
