...
define(['nf-common',
    ...
    function (nfCommon,
        ...
        var marshalDetails = function () {
            ...
            controllerServiceEntity['revision'] = nfClient.getRevision();
        ...
        var reloadControllerService = function (id) {
            ...
            if (nfCommon.isUndefined(controllerService)) {
         ...
         * @param {object} controllerService
         */
        var reloadControllerServiceReferences = function (controllerService, canvas) {
            ...
            $.each(controllerService.referencingComponents, function (_, reference) {
                if (reference.referenceType === 'Processor') {
                    ...
                    if (canvas.getGroupId() === reference.groupId) {
                        var processor = nfProcessor.get(reference.id);
                        nfProcessor.reload(processor.component);
                    }
            ...
            this.reloadReferencedServices(controllerService);
        };
        ...
        var saveControllerService = function (controllerService) {
            ...
            if (validateDetails(updatedControllerService)) {
                ...
                $.each(identifyReferencedServiceDescriptors(controllerService), function (_, descriptor) {
                    var modifyingService = !nfCommon.isUndefined(updatedControllerService.controllerService.properties) && !nfCommon.isUndefined(updatedControllerService.controllerService.properties[descriptor.name]);
                    var isCurrentlyConfigured = nfCommon.isDefinedAndNotNull(controllerService.properties[descriptor.name]);
                ...
                return $.ajax({
                    ...
                    if (nfCommon.isDefinedAndNotNull(response.controllerService)) {
                        // update the revision
                        nfClient.setRevision(response.revision);
        ...
        return {
             ...
             */
            showConfiguration: function (controllerService, canvas) {
                            ...
                            handler: {
                                click: function () {
                                    var openCustomUi = function () {
                                        ...
                                        // show the custom ui
                                        nfCustomUi.showCustomUi($('#controller-service-id').text(), controllerService.customUiUrl, true).done(function () {
             ...
             * @param {object} controllerService
             */
            showDetails: function(controllerService, canvas) {
                var controllerServiceDialog = $('#controller-service-configuration');
                        ...
                        buttons.push({
                            ...
                            handler: {
                                click: function () {
                                    ...
                                    // show the custom ui
                                    nfCustomUi.showCustomUi(controllerService.id, controllerService.customUiUrl, false).done(function () {
                                        nfSettings.showSettings();
                                    });
                                }
                            }
