...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['$',
                ...
                'nf.Shell',
                'nf.Canvas'],
            function ($, d3, errorHandler, common, client, canvasUtils, angularBridge, dialog, shell, canvas) {
                return (nf.PolicyManagement = factory($, d3, errorHandler, common, client, canvasUtils, angularBridge, dialog, shell, canvas));
            });
...
}(this, function ($, d3, errorHandler, common, client, canvasUtils, angularBridge, dialog, shell, canvas) {
    'use strict';
    ...
    var nfPolicyManagement = {
        ...
        showComponentPolicy: function (selection) {
            ...
            var resource;
            if (selection.empty()) {
                $('#selected-policy-component-id').text(canvas.getGroupId());
