...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery',
                ...
                'nf.ComponentState',
                'nf.ng.Bridge'],
            function ($, d3, Slick, client, shell, processGroupConfiguration, canvas, errorHandler, dialog, common, controllerService, processGroup, policyManagement, componentState, angularBridge) {
                return (nf.ControllerServices = factory($, d3, Slick, client, shell, processGroupConfiguration, canvas, errorHandler, dialog, common, controllerService, processGroup, policyManagement, componentState, angularBridge));
            });
...
}(this, function ($, d3, Slick, client, shell, processGroupConfiguration, canvas, errorHandler, dialog, common, controllerService, processGroup, policyManagement, componentState, angularBridge) {
    'use strict';
