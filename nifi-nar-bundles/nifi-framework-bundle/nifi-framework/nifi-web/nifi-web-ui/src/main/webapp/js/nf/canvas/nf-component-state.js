...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery',
                ...
                'nf.Dialog',
                'nf.Common'],
            function ($, clusterSummary, errorHandler, dialog, common) {
                return (nf.ComponentState = factory($, clusterSummary, errorHandler, dialog, common));
            });
...
}(this, function ($, clusterSummary, errorHandler, dialog, common) {
    'use strict';
